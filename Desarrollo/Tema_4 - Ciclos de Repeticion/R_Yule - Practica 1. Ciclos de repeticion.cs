...
{
    inicializar en entero a cont=0, totCeros=0, sumaNeg=0, num=0;
    inicializar en flotante a sumaPos=0, totPos=0;
    mientras (cont<25)
        {
...
{
    inicializar en entero a cont = 0, numero = 0, cantidad = 0, menor25 = 0, mayor75 = 0, total_rango = 0;
...
Algoritmo EnterosRango
{
    inicializar en entero a numero = 0, cantidad = 0, menor25 = 0, mayor75 = 0, total_rango = 0;
